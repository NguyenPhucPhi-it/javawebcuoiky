    ...
    <div class="app-main">
        <nav class="sidebar bg-primary">
            <ul>
                ...
                <li><a href="user.html"><i class="fa-solid fa-user ico-side"></i>Quản lí thành viên</a></li>
                <li><a href="order.html"><i class="fa-solid fa-cart-shopping ico-side"></i>Quản lí đơn hàng</a></li>
