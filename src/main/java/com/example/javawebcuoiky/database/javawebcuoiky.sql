...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2026 at 03:52 AM
...
CREATE TABLE `orders` (
  ...
  `order_date` time(6) DEFAULT NULL,
...
(1, 'nha 11,xom An Lac, tinh Dong Nai', 2, '08:25:31.000000', 'anh@gmail.com', 'Anh', '0328859476', 'Đang giao');
...
(1, 0, 1, 8, 2, 0, 1234567890, 'Đang giao'),
(2, 0, 1, 6, 1, 0, 123456789, 'Đã xác nhận'),
...
(4, 'Ghi âm 24h, lọc âm', NULL, 0, 3, '1779808201663_photo-1748327929572-2ccf5716d3b9.avif', 'svsdfvds', 15900000, 0),
...
(21, 1, 2, 869000, 1, NULL),
(22, 4, 2, 15900000, 2, NULL),
(23, 7, 2, 1234567890, 1, NULL);
